...
public class MainViewEmployeeController implements Initializable
{
    @FXML
    AnchorPane rootPane;

    @FXML
    private JFXButton btnInventoryNM;

    @FXML
    private JFXButton btnCustomerNM;

    @FXML
    private JFXButton btnRentalsNM;

    @FXML
    private JFXButton btnExitNM;
